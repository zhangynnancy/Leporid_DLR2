...
def train(all_data, test_model, save_performance, draw_loss, add_sch):
    ...
    hyperparameters = {'dim': args.curdim, 'norm': args.curnorm, 'lr': args.curlr, 'spectopk': args.curtopk,
                       'dis': args.curdis}
        ...
        for iteration in tqdm(range(args.max_pre_iteration)):
            ...
            if test_model and (iteration + 1) % 100 == 0:
                ...
                if save_performance:
                    ...
                    wb.save(
                        result_path + args.dataset + '_' + str(args.curdim) + args.initialization + str(
                            args.curlr) + str(args.curtopk) + str(args.curdis) + str(args.coefficient) + '.xls')
                ...
                if best_test_actor < cur_best_test_actor:
                    ...
                    d = args.initial_type + str(args.curdim) + '_bestActor/'
                ...
                if best_test_critic < cur_best_test_critic:
                    ...
                    d = args.initial_type + str(args.curdim) + '_bestCritic/'
                    path = args.data_folder + d
                    folder = os.path.exists(path)
